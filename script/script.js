...
class Explotion {
    ...
    update(deltatime){
        ...
        if (this.timeSinceLastFrame > this.frameInterval){
            this.frame++;
            this,this.timeSinceLastFrame = 0;
...
function animate(timestamp){
    ...
    drawScore();
    [ ...particles, ...ravens, ...explotions].forEach(object => object.update(deltaTime));
    [...particles, ...ravens, ...explotions].forEach(object => object.draw());
